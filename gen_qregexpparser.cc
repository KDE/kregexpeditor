...
#line 90 "qregexpparser.y"
    {
               if ( dynamic_cast<AltnRegExp*>( (yyvsp[(1) - (3)].regexp) ) ) {
                 ...
                 dynamic_cast<AltnRegExp*>( (yyval.regexp) )->addRegExp( (yyvsp[(1) - (3)].regexp) );
               }
               dynamic_cast<AltnRegExp*>( (yyval.regexp) )->addRegExp( (yyvsp[(3) - (3)].regexp) );
             }
    break;
...
#line 101 "qregexpparser.y"
    { 
               if ( dynamic_cast<AltnRegExp*>( (yyvsp[(1) - (2)].regexp) ) ) {
                 ...
                 (yyval.regexp) = new AltnRegExp( false );
                 dynamic_cast<AltnRegExp*>( (yyval.regexp) )->addRegExp( (yyvsp[(1) - (2)].regexp) );
               }
...
#line 111 "qregexpparser.y"
    {  
               (yyval.regexp) = new AltnRegExp( false );
               dynamic_cast<AltnRegExp*>( (yyval.regexp) )->addRegExp( new TextRegExp( false, QString::fromLatin1("") ) );
               dynamic_cast<AltnRegExp*>( (yyval.regexp) )->addRegExp( (yyvsp[(2) - (2)].regexp) );
             }
    break;
...
#line 119 "qregexpparser.y"
    {
       ...
       if ( last && ( reg1 = dynamic_cast<TextRegExp*>( last ) ) &&
            ( reg2 = dynamic_cast<TextRegExp*>( (yyvsp[(2) - (2)].regexp) ) ) ) {
         reg1->append( reg2->text() );
         delete reg2;
       }
       else {
         dynamic_cast<ConcRegExp*>((yyval.regexp))->addRegExp( (yyvsp[(2) - (2)].regexp) );
       }
       (yyval.regexp) = (yyvsp[(1) - (2)].regexp);
     }
    break;
...
/* Line 1806 of yacc.c  */
#line 1681 "gen_qregexpparser.cc"
      default: break;
    }
